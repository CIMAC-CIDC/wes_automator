...
class Update(Resource):
    def put(self, instance_name):
        if instance_name in _wes_runs:
            result = _wes_runs[instance_name]
...
class WesRun():
    ...
    #def __init__(self, **kwargs):
        ...
        self.num_steps = 0 #total number of wes steps
...
def main():
    ...
    for wes_run in wes_runs_configs:
        tmp = WesRun(**wes_run)
        _wes_runs[tmp.instance_name] = tmp
    #print(wes_runs)
